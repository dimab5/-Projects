...
public class TestAvgurStella
{
    public static IEnumerable<object[]> Data =>
        new List<object[]>
        {
            new object[]
            {
                ...
                new NebulaeIncreasedDensitySpace(1000, new AntimatterFlare(0)),
            },
        };
        ...
        IShip firstShip, IShip secondShip, ISpace space)
    {
        ...
        ResultPassingSpace resultWalkingShuttle = routeWalkingShuttle.PassingRoute();
        ResultPassingSpace resultVaclas = routeVaclas.PassingRoute();
